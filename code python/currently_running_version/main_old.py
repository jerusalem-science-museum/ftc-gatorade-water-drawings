...
while(running):
    ...
    if camera_on and time.time() - last_capture >= space_time/1000 and arduino_done:  
        ...
        #image_bw_display = pygame.transform.scale(image_bw_display, (screen_width, screen_height//2))
        #image_display = pygame.transform.scale(image_display, (screen_width, screen_height//2))
        #screen.blit(image_display, (0, 0))
        #screen.blit(image_bw_display, (0, screen_height//2))
